...
/************************************************************************************
 * Description: the base address as pointer to the RCC registers
 ************************************************************************************/
#define RCC ((Rcc_RegisterOffset_t* )RCC_BASEADDRESS)
/************************************************************************************
 * Description: SW valuess
 ************************************************************************************/
#define HSI_SW 0
#define HSE_SW 1
#define PLL_SW 2
/************************************************************************************
 * Description: SWS values
 ************************************************************************************/
#define HSI_SWS 0x00000000
#define HSE_SWS 0x00000004
#define PLL_SWS 0x00000008
/************************************************************************************
 * Description: masked bits
 ************************************************************************************/
...
/************************************************************************************
 * Description: RCC PLL configuration register (RCC_PLLCFGR) PINS
 ************************************************************************************/
#define PLLM0 0
#define PLLN0 6
#define PLLP0 16
...
/************************************************************************************
 * Description: RCC Registers offset
 ************************************************************************************/
typedef struct
{
	volatile u32 CR;
